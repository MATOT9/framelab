...
REQUIRED_FILES = (
    ...
    "docs/user-guide/workflow-structure.md",
    ...
    "docs/user-guide/analysis/event-signature.md",
    ...
    "docs/development/repo_conventions.md",
    "docs/development/change_workflow.md",
    "docs/development/context_strategy.md",
    "docs/development/troubleshooting.md",
    "docs/handoffs/feature_handoff_template.md",
    "docs/handoffs/bugfix_handoff_template.md",
    "docs/handoffs/refactor_handoff_template.md",
    "docs/maintenance/tooling_map.md",
    "docs/maintenance/benchmark_workflow.md",
    "docs/AGENTS.md",
...
EXPECTED_BUILD_OUTPUTS = (
    ...
    ".docs_build/check-site/user-guide/workflow-structure.html",
    ".docs_build/check-site/user-guide/data/session-manager.html",
    ".docs_build/check-site/user-guide/data/ebus-config-tools.html",
    ".docs_build/check-site/user-guide/analysis/event-signature.html",
    ".docs_build/check-site/developer-guide/index.html",
    ".docs_build/check-site/developer-guide/ebus-config-integration.html",
    ".docs_build/check-site/development/repo_conventions.html",
    ".docs_build/check-site/development/change_workflow.html",
    ".docs_build/check-site/development/context_strategy.html",
    ".docs_build/check-site/development/troubleshooting.html",
    ".docs_build/check-site/handoffs/feature_handoff_template.html",
    ".docs_build/check-site/handoffs/bugfix_handoff_template.html",
    ".docs_build/check-site/handoffs/refactor_handoff_template.html",
    ".docs_build/check-site/maintenance/tooling_map.html",
    ".docs_build/check-site/maintenance/benchmark_workflow.html",
    ".docs_build/check-site/AGENTS.html",

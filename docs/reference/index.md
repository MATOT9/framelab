...
- use this **Reference** section for configuration files, manifest payloads, mapping fields, and shortcut behavior

## Available reference pages

- [Config Files](config-files.md)
- [Plugin Manifests](plugin-manifests.md)
- [Acquisition Mapping](acquisition-mapping.md)
- [eBUS Parameter Catalog](ebus-parameter-catalog.md)
...
- file locations, payload fields, and shortcut scope belong here

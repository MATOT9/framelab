...
- Main workflow tab changes are view transitions. They update layout, hints, and visible analysis delivery when needed, but they do not start scans, metric recompute, cache flushes, or analysis invalidation by themselves.
